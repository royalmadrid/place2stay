...
import { Box, Divider, IconButton, Typography, styled, List, ListItem, ListItemIcon, ListItemButton,  ListItemText, Tooltip, Avatar
          } from '@mui/material';
import { ChevronRight, Dashboard, KingBed, Logout, MarkChatUnread, NotificationsActive, PeopleAlt } from '@mui/icons-material';
...
const SideList = ({open, setOpen}) => {
  useCheckToken();
  const {state:{currentUser, location,
    details,
    images,
    updatedRoom,
    deletedImages,
